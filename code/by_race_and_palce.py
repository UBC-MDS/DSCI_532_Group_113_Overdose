...
def make_bar_plot(race='Black',place ='Hospital'):
...
# alt.data_transformers.enable('json')
    ...
    by_race_place = drug_overdose_wrangled_m[(drug_overdose_wrangled_m['Race']==race) & (drug_overdose_wrangled_m['Location']==place)]
...
def update_plot(race_name,place_name):
    ...
    '''
    updated_plot = make_bar_plot(race_name,place_name).to_html()
    return updated_plot
